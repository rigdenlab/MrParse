# -*- coding: utf-8 -*-
#
# MRPARSE documentation build configuration file, created by
...
author = u'Adam Simpkin, Jens Thomas, Ronan Keegan & Daniel Rigden'

# The short X.Y version.
import mrparse.mr_version
version = mrparse.mr_version.__version__
...
html_context = {
    ...
    'github_url': 'https://github.com/rigdenlab/mrparse.git',
}
...
html_title = u'MrParse v{0}'.format(version)

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = u'MrParse'

# The name of an image file (relative to this directory) to place at the top
# of the sidebar.
html_logo = '_static/logo_mrparse.svg'
...
man_pages = [(master_doc, 'mrparse', u'MRPARSE Documentation', [author], 1)]
...
texinfo_documents = [
    (master_doc, 'MRPARSE', u'MRPARSE Documentation', author, 'MRPARSE', 'One line description of project.',
     'Miscellaneous'),
]
...
def run_apidoc(_):
    root = os.path.join('..', 'mrparse')
    ignore_paths = [os.path.join(root, 'html'), os.path.join(root, 'scripts')]
