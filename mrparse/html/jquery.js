...
function selectTableAndFeatures(feature_viewer) {
    ...
    var tableToContainerMap = {
		'hkl_table': 'hkl_table',
        'pdb_table': 'pdb-feature-viewer-container',
        'af_table': 'af-feature-viewer-container',
		'bfvd_table': 'bfvd-feature-viewer-container',
        'esm_table': 'esm-feature-viewer-container'
    };

    $(function() {
        $('#hkl_table tbody tr, #pdb_table tbody tr, #af_table tbody tr, #bfvd_table tbody tr, #esm_table tbody tr').on('click', function() {
...
function sortTableAndFeatures(table_id, sequence, feature_viewer, rowFeatureMap, div_id, n) {
	...
	for (var i = 1; i < rows.length; i++) {
		if (table_id == 'pdb_table') {
			var firstColumnValue = 'PDB-' + rows[i].cells[0].innerText;
		} else if (table_id == 'af_table' || table_id == 'bfvd_table' || table_id == 'esm_table') {
	...
	// Add the features back in the new order
	var options = {
		showAxis: true,
		showSequence: true,
		brushActive: true,
